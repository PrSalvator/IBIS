...
export const ConvertTextToNumArrayForm = () => {
  const { form, handleSubmit, answer } = useConvertTextToNumArrayFormPresenter()
  const {
    register,
    formState: { errors },
  } = form;
  ...
  return (
    <div>
      <h1 className="text-[20px] font-bold">Коевертирование строки в массив номеров</h1>
