...
export const ModifiedCesareCipherDecryptForm = () => {
  const { form, handleSubmit, answer } = useModifidCesareCipherDecryptFormPresenter();
  const {
    register,
    formState: { errors },
  } = form;
  ...
  return (
    <div>
      <h1 className="text-[20px] font-bold">Полиалфавитный шифр Цезаря для расшифровки текста</h1>
